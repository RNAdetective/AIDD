...
prefetch $fn
mkdir -p "$path/$fn"
mv /home/user/ncbi/public/sra/"$fn.sra" $path/$fn/"$fn.sra"
done
fi

if  [ "$variable" == "GRCh38" ]; then
echo "Bulk downloading, extracting, and moving all needed reference and index files"
wget -q ftp://ftp.ccb.jhu.edu/pub/infphilo/hisat2/data/grch38.tar.gz
...
wget -q ftp://ftp.ensembl.org/pub/release-89/fasta/homo_sapiens/cdna/Homo_sapiens.GRCh38.89.cdna.all.fa.gz
...
wget -q ftp://ftp.ensembl.org/pub/release-89/gtf/homo_sapiens/Homo_sapiens.GRCh38.89.gtf.gz
...
wget -q ftp://ftp.ensembl.org/pub/release-89/fasta/homo_sapiens/dna/Homo_sapiens.GRCh38.89.dna.primary_assembly.fa.gz
...
wget -q ftp://gsapubftp-anonymous@ftp.broadinstitute.org/bundle/b38/dbsnp_138.b38.vcf.gz
...
echo "Bulk downloading, extracting, and moving all needed reference and index files"
wget -q ftp://ftp.ccb.jhu.edu/pub/infphilo/hisat2/data/grch38_snp.tar.gz
echo "Uncompressing and moving genome reference for alignment step"
...
echo "Bulk downloading, extracting, and moving all needed reference and index files"
wget -q ftp://ftp.ccb.jhu.edu/pub/infphilo/hisat2/data/grch38_tran.tar.gz
echo "Uncompressing and moving genome reference for alignment step"
tar xzvf grch38_snp.tar.gz
...
echo "Bulk downloading, extracting, and moving all needed reference and index files"
wget -q ftp://ftp.ccb.jhu.edu/pub/infphilo/hisat2/data/grch37.tar.gz
echo "Uncompressing and moving genome reference for alignment step"
...
wget -q ftp://ftp.ensembl.org/pub/release-75/fasta/homo_sapiens/cdna/Homo_sapiens.GRCh37.75.cdna.all.fa.gz
echo "Uncompressing and moving genome fasta cdna file for trancriptome assembly step"
gunzip Homo_sapiens.GRCh37.75.cdna.all.fa.gz
mv $path/*.fa $path/ref.fa
wget -q ftp://ftp.ensembl.org/pub/release-75/gtf/homo_sapiens/Homo_sapiens.GRCh37.75.gtf.gz
echo "Uncompressing and moving gtf file for transcriptome assembly step"
...
echo "Bulk downloading, extracting, and moving all needed reference and index files"
wget -q ftp://ftp.ccb.jhu.edu/pub/infphilo/hisat2/data/grch37_tran.tar.gz
echo "Uncompressing and moving genome reference for alignment step"
...
echo "Bulk downloading, extracting, and moving all needed reference and index files"
wget -q ftp://ftp.ccb.jhu.edu/pub/infphilo/hisat2/data/grch37_snp.tar.gz
echo "Uncompressing and moving genome reference for alignment step"
...
echo "Bulk downloading, extracting, and moving all needed reference and index files"
wget -q ftp://ftp.ccb.jhu.edu/pub/infphilo/hisat2/data/grch37_snp_tran.tar.gz
echo "Uncompressing and moving genome reference for alignment step"
...
rm "$path/Results/DESeq2_transcript/$i"
done
