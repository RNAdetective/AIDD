...
geneCounts <- plotCounts(dds, gene = "GOI_name", intgroup = c("condition"), returnData = TRUE)
tiff("/media/sf_AIDD/Results/DESeq2/gene/counts/GOI_namecounts3.tiff")
...
dev.off()
geneCounts <- plotCounts(dds, gene = "GOI_name", intgroup = c("condition"), returnData = TRUE)
tiff("/media/sf_AIDD/Results/DESeq2/gene/counts/GOI_namecounts4.tiff")
