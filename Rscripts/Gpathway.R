...
colnames(anno) <- "_name"
tiff("/media/sf_AIDD/Results/pathway/heatmaps/file_name_heatmap.tiff", units="in", width=10, height=10, res=900)
pheatmap(mat, annotation_col = anno, annotation_legend=FALSE, show_rownames = TRUE)
dev.off()
dds <- DESeq(dds)
res <- results(dds)
...
tiff("/media/sf_AIDD/Results/pathway/volcano/file_name_VolcanoPlot.tiff", units="in", width=10, height=10, res=900)
