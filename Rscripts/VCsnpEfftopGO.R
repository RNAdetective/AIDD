...
geneID2GO <- readMappings(file = "annotations2.csv", sep = ",")
geneUniverse <- names(geneID2GO)
genesOfInterest <- read.table("differencescondition_1HIGH.csv", header=FALSE)
genesOfInterest <- as.character(genesOfInterest$V1)
geneList <- factor(as.integer(geneUniverse %in% genesOfInterest))
names(geneList) <- geneUniverse
geneUniverse <- gsub("\\\"", "", geneUniverse)
...
resultKS.elim <- runTest(myGOdata, algorithm = "elim", satistic = "ks")
allRes <- GenTable(myGOdata,classicFisher=resultFisher,orderBy="resultFisher",ranksOf="classicFisher",topNodes=10)
write.csv(allRes, "differencescondition_1HIGHtopGO.csv", row.names=FALSE)
showSigOfNodes(myGOdata,score(resultFisher),firstSigNodes=10,useInfo='all')
printGraph(myGOdata,resultFisher,firstSigNodes=5,fn.prefix="VCAML",useInfo="all",pdfSW=TRUE)
dev.off()
length(usedGO(myGOdata))
...
geneID2GO <- readMappings(file = "annotations2.csv", sep = ",")
geneUniverse <- names(geneID2GO)
genesOfInterest <- read.table("differencesconditions_2HIGH.csv", header=FALSE)
genesOfInterest <- as.character(genesOfInterest$V1)
geneList <- factor(as.integer(geneUniverse %in% genesOfInterest))
names(geneList) <- geneUniverse
geneUniverse <- gsub("\\\"", "", geneUniverse)
...
resultKS.elim <- runTest(myGOdata, algorithm = "elim", satistic = "ks")
allRes <- GenTable(myGOdata,classicFisher=resultFisher,orderBy="resultFisher",ranksOf="classicFisher",topNodes=10)
write.csv(allRes, "differencescondtion_2HIGHtopGO.csv", row.names=FALSE)
showSigOfNodes(myGOdata,score(resultFisher),firstSigNodes=10,useInfo='all')
printGraph(myGOdata,resultFisher,firstSigNodes=5,fn.prefix="VCAML",useInfo="all",pdfSW=TRUE)
dev.off()
length(usedGO(myGOdata))
...
geneID2GO <- readMappings(file = "annotations2.csv", sep = ",")
geneUniverse <- names(geneID2GO)
genesOfInterest <- read.table("differencescondition_1Moderate.csv", header=FALSE)
genesOfInterest <- as.character(genesOfInterest$V1)
geneList <- factor(as.integer(geneUniverse %in% genesOfInterest))
names(geneList) <- geneUniverse
geneUniverse <- gsub("\\\"", "", geneUniverse)
...
resultKS.elim <- runTest(myGOdata, algorithm = "elim", satistic = "ks")
allRes <- GenTable(myGOdata,classicFisher=resultFisher,orderBy="resultFisher",ranksOf="classicFisher",topNodes=10)
write.csv(allRes, "differencescondition_1Moderate.csv", row.names=FALSE)
showSigOfNodes(myGOdata,score(resultFisher),firstSigNodes=10,useInfo='all')
printGraph(myGOdata,resultFisher,firstSigNodes=5,fn.prefix="VCAML",useInfo="all",pdfSW=TRUE)
dev.off()
length(usedGO(myGOdata))
...
geneID2GO <- readMappings(file = "annotations2.csv", sep = ",")
geneUniverse <- names(geneID2GO)
genesOfInterest <- read.table("differencescondition_2Moderate.csv", header=FALSE)
genesOfInterest <- as.character(genesOfInterest$V1)
geneList <- factor(as.integer(geneUniverse %in% genesOfInterest))
names(geneList) <- geneUniverse
geneUniverse <- gsub("\\\"", "", geneUniverse)
...
resultKS.elim <- runTest(myGOdata, algorithm = "elim", satistic = "ks")
allRes <- GenTable(myGOdata,classicFisher=resultFisher,orderBy="resultFisher",ranksOf="classicFisher",topNodes=10)
write.csv(allRes, "differencescondition_2Moderate.csv", row.names=FALSE)
showSigOfNodes(myGOdata,score(resultFisher),firstSigNodes=10,useInfo='all')
printGraph(myGOdata,resultFisher,firstSigNodes=5,fn.prefix="VCAML",useInfo="all",pdfSW=TRUE)
dev.off()
length(usedGO(myGOdata))
