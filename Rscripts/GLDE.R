...
jpeg("ADAR2counts2.jpeg")
ggplot(geneCounts, aes(x = condition, y = count, color = condition, shape = condition)) + scale_y_log10() +  geom_beeswarm(cex = 3) + geom_point(size = 3)
dev.off()
geneCounts <- plotCounts(dds, gene = "ADARB1", intgroup = c("condition"), returnData = TRUE)
jpeg("ADAR2counts3.jpeg")
ggplot(geneCounts, aes(x = condition, y = count, color = condition, label=rownames(pcaData))) + scale_y_log10() +  geom_beeswarm(cex = 3) + geom_line() +geom_text(aes(label=rownames(pcaData))) + geom_point(size = 0)
dev.off()
geneCounts <- plotCounts(dds, gene = "ADARB1", intgroup = c("condition"), returnData = TRUE)
jpeg("ADAR2counts4.jpeg")
ggplot(geneCounts, aes(x = condition, y = count, color = condition, label=rownames(pcaData))) + scale_y_log10() +  geom_beeswarm(cex = 3) +geom_text(aes(label=rownames(pcaData))) + geom_point(size = 0)
dev.off()
jpeg("ADAR3counts.jpeg")
...
jpeg("ADAR3counts2.jpeg")
ggplot(geneCounts, aes(x = condition, y = count, color = condition, shape = condition)) + scale_y_log10() +  geom_beeswarm(cex = 3) + geom_point(size = 3)
dev.off()
geneCounts <- plotCounts(dds, gene = "ADARB2", intgroup = c("condition"), returnData = TRUE)
jpeg("ADAR3counts3.jpeg")
ggplot(geneCounts, aes(x = condition, y = count, color = condition, label=rownames(pcaData))) + scale_y_log10() +  geom_beeswarm(cex = 3) +geom_text(aes(label=rownames(pcaData))) + geom_point(size = 0)
dev.off()
geneCounts <- plotCounts(dds, gene = "ADARB2", intgroup = c("condition"), returnData = TRUE)
jpeg("ADAR3counts4.jpeg")
ggplot(geneCounts, aes(x = condition, y = count, color = condition, label=rownames(pcaData))) + scale_y_log10() +  geom_beeswarm(cex = 3) + geom_line() +geom_text(aes(label=rownames(pcaData))) + geom_point(size = 0)
dev.off()
...
nrow(dds)
rld <- rlog(dds, blind = FALSE)
jpeg("pos_myeloid_diff_genesPCAplot2.jpeg")
ggplot(pcaData, aes(x = PC1, y = PC2, color = condition, group = condition, label=rownames(pcaData))) + geom_point(size = 0) + xlab(paste0("PC1: ", percentVar[1], "% variance")) + ylab(paste0("PC2: ", percentVar[2], "% variance")) + coord_fixed() +geom_text(aes(label=rownames(pcaData)))
dev.off()
mat  <- assay(rld)
mat  <- mat - rowMeans(mat)
...
nrow(dds)
rld <- rlog(dds, blind = FALSE)
jpeg("neg_myeloid_diff_genesPCAplot2.jpeg")
ggplot(pcaData, aes(x = PC1, y = PC2, color = condition, group = condition, label=rownames(pcaData))) + geom_point(size = 0) + xlab(paste0("PC1: ", percentVar[1], "% variance")) + ylab(paste0("PC2: ", percentVar[2], "% variance")) + coord_fixed() +geom_text(aes(label=rownames(pcaData)))
dev.off()
mat  <- assay(rld)
mat  <- mat - rowMeans(mat)
...
nrow(dds)
rld <- rlog(dds, blind = FALSE)
jpeg("myeloid_homo_genesPCAplot2.jpeg")
ggplot(pcaData, aes(x = PC1, y = PC2, color = condition, group = condition, label=rownames(pcaData))) + geom_point(size = 0) + xlab(paste0("PC1: ", percentVar[1], "% variance")) + ylab(paste0("PC2: ", percentVar[2], "% variance")) + coord_fixed() +geom_text(aes(label=rownames(pcaData)))
dev.off()
mat  <- assay(rld)
mat  <- mat - rowMeans(mat)
...
tablebargraphF <- colnames(tablebargraph5)[2] <- "AML"
...
tablebargraphI <- colnames(tablebargraph6)[2] <- "AML"
...
ggplot(final, aes(x=t_name, y=AML, fill=condition)) +
