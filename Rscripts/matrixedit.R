...
table10 <-colnames(table1)[c(2:5)] <- rownames(Data)[c(1:4)]
write.csv(table1, "/media/sf_AIDD/Results/DESeq2/gene/counts/gene_count_matrixID.csv", row.names=FALSE)
...
Data <- read.csv("/media/sf_AIDD/PHENO_DATA.csv", row.names=1)
table10 <-colnames(table1)[c(2:5)] <- rownames(Data)[c(1:4)]
write.csv(table1, "/media/sf_AIDD/Results/DESeq2/transcript/counts/transcript_count_matrixID.csv", row.names=FALSE)
