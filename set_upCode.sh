...
sudo apt-get -y install gsl-bin libgsl2
sudo apt-get -y install libtiff-dev
sudo apt-get -y install build-essential python2.7-dev python-htseq
...
cp /home/user/samtools-1.3.1/samtools /home/user/Pipeline/HISAT2_pipeline/bin
cd /home/user/
