...
for l in $conditionname1 $conditionname2 ; do
  sed -i 's/level/'$i'/g' /media/sf_AIDD/ExToolset/multimergeimpact.R
  sed -i 's/protein_effect/'$j'/g' /media/sf_AIDD/ExToolset/multimergeimpact.R
  sed -i 's/condition/'$l'/g' /media/sf_AIDD/ExToolset/multimergeimpact.R 
  Rscript  /media/sf_AIDD/ExToolset/multimergeimpact.R
  sed -i 's/'$i'/level/g' /media/sf_AIDD/ExToolset/multimergeimpact.R
  sed -i 's/'$j'/protein_effect/g' /media/sf_AIDD/ExToolset/multimergeimpact.R
  sed -i 's/'$l'/condition/g' /media/sf_AIDD/ExToolset/multimergeimpact.R
done
done
done
...
sed -i 's/DESeq2\/level\/differential_expression\/venndiagrams\/file_name/variant_calling\/level\/protein_effect_impact\/final\/levelprotein_effectfinal/g' /media/sf_AIDD/ExToolset/Gvenn.R
for i in gene transcript ; do
for j in moderate high ; do
sed -i 's/level/'$i'/g' /media/sf_AIDD/ExToolset/Gvenn.R
sed -i 's/protein_effect/'$j'/g' /media/sf_AIDD/ExToolset/Gvenn.R
sed -i 's/set_column_name/"'$conditionname1'","'$conditionname2'"/g' /media/sf_AIDD/ExToolset/Gvenn.R 
...
sed -i 's/"'$conditionname1'","'$conditionname2'"/set_column_name/g' /media/sf_AIDD/ExToolset/Gvenn.R
sed -i 's/"red","blue"/set_colors/g' /media/sf_AIDD/ExToolset/Gvenn.R
sed -i 's/0.5,0.5/set_alpha/g' /media/sf_AIDD/ExToolset/Gvenn.R
sed -i 's/'$i'/level/g' /media/sf_AIDD/ExToolset/Gvenn.R
sed -i 's/'$j'/protein_effect/g' /media/sf_AIDD/ExToolset/Gvenn.R
done
done
sed -i 's/variant_calling\/level\/protein_effect_impact\/final\/levelprotein_effectfinal/DESeq2\/level\/differential_expression\/venndiagrams\/file_name/g' /media/sf_AIDD/ExToolset/Gvenn.R
##to create unique gene lists
sed -i 's/file_name/levelprotein_effectfinal/g' /media/sf_AIDD/ExToolset/venntexttogenelistimpact.sh
for i in gene transcript ; do
for j in moderate high ; do
sed -i 's/level/'$i'/g' /media/sf_AIDD/ExToolset/venntexttogenelistimpact.sh
sed -i 's/protein_effect/'$j'/g' /media/sf_AIDD/ExToolset/venntexttogenelistimpact.sh
bash /media/sf_AIDD/ExToolset/venntexttogenelistimpact.sh
sed -i 's/'$i'/level/g' /media/sf_AIDD/ExToolset/venntexttogenelistimpact.sh
sed -i 's/'$j'/protein_effect/g' /media/sf_AIDD/ExToolset/venntexttogenelistimpact.sh
done
done
sed -i 's/levelprotein_effectfinal/file_name/g' /media/sf_AIDD/ExToolset/venntexttogenelistimpact.sh
