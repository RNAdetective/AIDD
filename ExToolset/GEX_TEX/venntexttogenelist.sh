...
sed -i 's/,E/E/g' /media/sf_AIDD/Results/DESeq2/"$i"/differential_expression/venndiagrams/file_namevenn.txt
## this gets rid of [#] counting the "$i" s
sed -i 's/\[//g' /media/sf_AIDD/Results/DESeq2/"$i"/differential_expression/venndiagrams/file_namevenn.txt
sed -i 's/\]//g' /media/sf_AIDD/Results/DESeq2/"$i"/differential_expression/venndiagrams/file_namevenn.txt
sed -i 's/[0-9]* //g' /media/sf_AIDD/Results/DESeq2/"$i"/differential_expression/venndiagrams/file_namevenn.txt
## this puts them all in their own new line
sed -i 's/,/\n/g' /media/sf_AIDD/Results/DESeq2/"$i"/differential_expression/venndiagrams/file_namevenn.txt
...
sed -i 's/`//g' /media/sf_AIDD/Results/DESeq2/"$i"/differential_expression/venndiagrams/file_namevenn.txt
sed 's/:/_/g' /media/sf_AIDD/Results/DESeq2/"$i"/differential_expression/venndiagrams/file_namevenn.txt  > /media/sf_AIDD/Results/DESeq2/"$i"/differential_expression/venndiagrams/file_namevenn.csv
