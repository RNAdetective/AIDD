...
nrow(dds)
tiff("/media/sf_AIDD/Results/DESeq2/level/calibration/rlogandvariance.tiff", units="in", width=10, height=10, res=600)
lambda <- 10^seq(from = -1, to = 2, length = 1000)
cts <- matrix(rpois(1000*100, lambda), ncol = 100)
meanSdPlot(cts, ranks = FALSE)
dev.off()
tiff("/media/sf_AIDD/Results/DESeq2/level/calibration/logtranscounts.tiff", units="in", width=10, height=10, res=600)
...
tiff("/media/sf_AIDD/Results/DESeq2/level/calibration/transcounts2sam.tiff", units="in", width=10, height=10, res=600)
...
tiff("/media/sf_AIDD/Results/DESeq2/level/calibration/PoisHeatmap.tiff", units="in", width=10, height=10, res=600)
pheatmap(samplePoisDistMatrix, clustering_distance_rows = poisd$dd, clustering_distance_cols = poisd$dd, col = colors)
dev.off()
tiff("/media/sf_AIDD/Results/DESeq2/level/PCA/PCAplot.tiff", units="in", width=10, height=10, res=600)
plotPCA(rld, intgroup = c("condition"))
dev.off()
pcaData <- plotPCA(rld, intgroup = c( "condition"), returnData = TRUE)
percentVar <- round(100 * attr(pcaData, "percentVar"))
tiff("/media/sf_AIDD/Results/DESeq2/level/PCA/PCAplot2.tiff", units="in", width=10, height=10, res=600)
...
tiff("/media/sf_AIDD/Results/DESeq2/level/PCA/MDSplot.tiff", units="in", width=10, height=10, res=600)
...
tiff("/media/sf_AIDD/Results/DESeq2/level/PCA/MDSpois.tiff", units="in", width=10, height=10, res=600)
...
write.csv(finaltable, "/media/sf_AIDD/Results/DESeq2/level/differential_expression/venndiagrams/upregGListtop100.csv", row.names=FALSE)
table4 <- table2[myvars]
write.csv(table4, "/media/sf_AIDD/Results/DESeq2/level/differential_expression/venndiagrams/upregGList.csv", row.names=FALSE)
...
myvars <- c("level_name")
finaltable <- datatop[myvars]
write.csv(finaltable, "/media/sf_AIDD/Results/DESeq2/level/differential_expression/venndiagrams/downregGListtop100.csv", row.names=FALSE)
table4 <- table2[myvars]
write.csv(table4, "/media/sf_AIDD/Results/DESeq2/level/differential_expression/venndiagrams/downregGList.csv", row.names=FALSE)
...
tiff("/media/sf_AIDD/Results/DESeq2/level/counts/top60heatmap.tiff", units="in", width=10, height=10, res=600)
...
write.csv(levelofinterestfinal, "/media/sf_AIDD/Results/DESeq2/level/differential_expression/levelofinterest/levelofinterestfinalresults.csv", row.names=FALSE)
...
write.csv(excitomefinal, "/media/sf_AIDD/Results/DESeq2/level/differential_expression/excitome/excitomefinalresults.csv", row.names=FALSE)
...
tiff("/media/sf_AIDD/Results/DESeq2/level/differential_expression/VolcanoPlot.tiff", units="in", width=10, height=10, res=600)
