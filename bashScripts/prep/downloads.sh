#!/usr/bin/env bash
main_function() {
export PATH=$PATH:/media/sf_AIDD/references:/home/user/AIDD/AIDD_tools/bin
##this is the function to download all necessary reference files
echo "Please choose a build to download and prepare reference files for the whole pipeline. 1=GRCh38 and 2=GRCh37"
read variable 
